  ...
  <div class="container-fluid p-0">
    ...
    <section class="resume-section p-3 p-lg-5 d-flex justify-content-center" id="experience">
      <div class="w-100">
        ...
        <?php $experiences = $pdo->query("SELECT * FROM experiences"); 
            ...
            while ($experience = $experiences->fetch(PDO::FETCH_OBJ)) { ?>
              ...
              <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
                ...
                <div class="resume-date text-md-right">
                  <span class="text-primary"><?php echo $experience->periode; ?></span><br>
                </div>
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="education">
      <div class="w-100">
        ...
        <?php $education = $pdo->query("SELECT * FROM education"); 
            ...
            while ($formation = $education->fetch(PDO::FETCH_OBJ)) { ?>
              ...
              <div class="resume-item d-flex flex-column flex-md-row justify-content-between">
                ...
                <div class="resume-date text-md-right">
                  ...
                  <span class="text-primary"><?php echo $formation->periode; ?></span><br>
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="skills">
      <div class="w-100">
        ...
        <ul class="list-inline dev-icons">
          ...
          <?php $devweb = $pdo->query("SELECT * FROM competencesweb"); 
        ...
        <ul class="list-inline dev-icons">
          ...
          <?php $devlog = $pdo->query("SELECT * FROM competenceslog"); 
        ...
        <?php $langue = $pdo->query("SELECT * FROM competenceslang"); 
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="interests">
      <div class="w-100">
        ...
        <?php $interet = $pdo->query("SELECT * FROM interets"); 
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="awards">
      <div class="w-100">
        ...
        <h2 class="mb-5">Récompenses et Certifications</h2>
        <ul class="fa-ul mb-0">

        <?php $recompenses = $pdo->query("SELECT * FROM recompenses"); 
